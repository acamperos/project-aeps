...
{        
    public List<ChemicalsSowing> findAll() {
    ...
    public List<ChemicalsSowing> findAllByTypeCrop(Integer idTypeCrop) {
        SessionFactory sessions = HibernateUtil.getSessionFactory();
        Session session = sessions.openSession();
        ...
        sql += "select p.id_che_sow, p.name_che_sow, p.status_che_sow";
