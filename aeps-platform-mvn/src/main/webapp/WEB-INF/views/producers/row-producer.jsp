        ...
        <td>
            <div class="btn-group">
                <% if (usrDao.getPrivilegeUser(user.getIdUsr(), "producer/modify")) { %>
                    <a class="btn btn-small btn-edit" title="Editar Productor" onclick="viewForm('/aeps-plataforma-mvn/showProducer.action?action=modify&page=<%=pageNow%>', 'idPro', <s:property value ="id_producer" />, 'Editar Productor', 1050, 550)"><i class="icon-pencil"></i></a>
                <% } %>
