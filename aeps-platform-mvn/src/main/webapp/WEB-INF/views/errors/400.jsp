            ...
            <div class="row">
                <div class="span12">
                    <div class="hero-unit center">
                        <h1><s:property value="getText('title.permission400.errors')" /> <small><font color="red"><s:property value="getText('text.permission400.errors')" /></font></small></h1>
                        <br />
                        <p><s:property value="getText('area.permission400.errors')" />. </p>
