...
<html>
    <head>
        ...
        <link rel="stylesheet" href="<%= request.getContextPath() %>/scripts/js/jquery/jquery-ui/themes/base/jquery.ui.all.css" />
        <link rel="stylesheet" href="<%= request.getContextPath() %>/scripts/js/jquery/jquery-ui/themes/base/jquery-ui.css" />
