...
<!--        <div class="links">
        ...
        Elaborado por grupo de AEPS. Contactenos <a href="mailto:contact@open-aeps.org">contact@open-aeps.org</a>.<br>
        Codigo de licencia <a href="http://www.apache.org/licenses/LICENSE-2.0" rel="nofollow">Apache License v2.0</a>.<br>
        Basado en <a href="http://getbootstrap.com/2.3.2/" rel="nofollow">Bootstrap</a>. Hosteado en <a href="https://code.google.com/p/project-aeps/" rel="nofollow">Google Code</a>. Iconos de <a href="http://fortawesome.github.com/Font-Awesome/" rel="nofollow">Font Awesome</a>. Web fonts de <a href="http://www.google.com/webfonts" rel="nofollow">Google</a>.
        <hr>
        <div class="row credits">
            <div class="copyright"> © 2014 CIAT-MADR. All rights reserved.</div>
        </div>
    </div>
</footer>
<!--<footer id="footer">
