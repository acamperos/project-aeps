        ...
        <div class="container">			
            ...
            <div class="row">
                <div class="span4">
                    ...
                    <p><sj:a cssClass="btn btn-primary" href="searchProducer.action" role="button" targets="divBodyLayout">Ir »</sj:a></p>
                </div>
                <div class="span4">
                    <img id="img_farmer" src="img/property.jpg"/>
                    <h3>Fincas</h3>
                    <p>Encargado de la toma de datos para las fincas</p>
                    <p><sj:a cssClass="btn btn-primary" href="searchFarm.action" role="button" targets="divBodyLayout">Ir »</sj:a></p>
                </div>
                <div class="span4">
                    <img id="img_farmer" src="img/lot.jpg"/>
                    <h3>Lotes</h3>
                    <p>Encargado de la toma de datos para los lotes</p>
                    <p><sj:a cssClass="btn btn-primary" href="searchField.action" role="button" targets="divBodyLayout">Ir »</sj:a></p>
                </div>
            </div>
            <div class="row">
                <div class="span4">
                    ...
                    <p><sj:a cssClass="btn btn-primary" href="#" role="button" targets="divBodyLayout">Ir »</sj:a></p>
                </div>
                <div class="span4">
