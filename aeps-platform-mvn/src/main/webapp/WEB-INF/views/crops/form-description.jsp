    ...
    <body>
        ...
        <div class="row-fluid" id="divDesForm">
            <s:form id="formCropDes" action="saveDescrip" cssClass="form-horizontal">
                <fieldset>
                    <legend>Formulario de observaciones</legend>
                    <div class="row">
                        <div class="span5">
                    ...
                    <div id="divBtDes">
                        ...
                        <% if ((actExe.equals("create") && usrDao.getPrivilegeUser(user.getIdUsr(), "crop/create")) || (actExe.equals("modify") && usrDao.getPrivilegeUser(user.getIdUsr(), "crop/modify"))) { %>
                            <sj:submit type="button" cssClass="btn btn-initial btn-large" onclick="addMessageProcess()" targets="divMessage" onCompleteTopics="completeDes" validate="true" validateFunction="validationForm"><i class="icon-save"></i>  Guardar Observación</sj:submit>
                        <% } %>
                        <button class="btn btn_default btn-large" onclick="resetForm('formCropDes'); closeWindow();"><i class="icon-ban-circle"></i>  Cancelar</button>
                    </div>
                </fieldset>
            </s:form>	
            <script>    
