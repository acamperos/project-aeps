    ...
    <% if (usrPrpDao.getPrivilegeUser(userPrp.getIdUsr(), "crop/modify") || (usrPrpDao.getPrivilegeUser(userPrp.getIdUsr(), "crop/delete"))) { %>
        <div class="btn-group">
            <% if (usrPrpDao.getPrivilegeUser(userPrp.getIdUsr(), "crop/modify")) { %>
                <a class="btn btn-small btn-edit" title="Editar Preparación" onclick="viewForm('/aeps-plataforma-mvn/crop/showPrep.action?action=modify&idCrop=${idCrop}', 'idPrep', ${idPrep}, 'Editar Preparación', 1050, 550);"><i class="icon-pencil"></i></a>
            <% } %>
