    ...
    <% if (usrMonDao.getPrivilegeUser(userMon.getIdUsr(), "crop/modify") || (usrMonDao.getPrivilegeUser(userMon.getIdUsr(), "crop/delete"))) { %>
        <div class="btn-group">
            <% if (usrMonDao.getPrivilegeUser(userMon.getIdUsr(), "crop/modify")) { %>
                <a class="btn btn-small btn-edit" title="Editar Monitoreo" onclick="viewForm('/aeps-plataforma-mvn/crop/showMon.action?action=modify&idCrop=${idCrop}', 'idMon', ${idMon}, 'Editar Monitoreo', 1050, 550);"><i class="icon-pencil"></i></a>
            <% } %>
