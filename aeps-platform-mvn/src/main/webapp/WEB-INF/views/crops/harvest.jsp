...
<s:form id="formCropHar" action="saveHarvest" cssClass="form-horizontal">
        ...
        <div class="span5">
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    ...
                    <s:textfield name="harv.dateHar" value="%{#dateTransform}"/>
    ...
    <%@page import="org.aepscolombia.platform.models.entity.Harvests"%>      
...
<div style="margin-bottom: 15px" id="divBtHarvest">
    <sj:submit type="button" formIds="formCropHar" cssClass="btn btn-initial btn-large" onclick="addMessageProcess()" targets="divMessHarvest" onCompleteTopics="completeHarvest"><i class="icon-pencil"></i>  Guardar Cosecha</sj:submit>
