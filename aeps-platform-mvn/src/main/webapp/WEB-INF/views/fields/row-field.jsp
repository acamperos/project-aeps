        ...
        <td>
            <div class="btn-group">
                <% if (usrDao.getPrivilegeUser(user.getIdUsr(), "field/modify")) { %>
                    <a class="btn btn-small btn-edit" title="Editar Lote" onclick="viewForm('/aeps-plataforma-mvn/showField.action?action=modify&page=<%=pageNow%>', 'idField', <s:property value ="id_lot" />, 'Editar Lote', 1050, 550)"><i class="icon-pencil"></i></a>
                <% } %>
