        ...
        <div id="login-wrapper" class="clearfix">
            <div class="main-col">
                    ...
                    <s:form id="formLogin" action="login.action" method="post" theme="simple">
                        ...
                        <div class="row">
                            ...
                            <div class="submit_sect">
                                ...
                                <sj:submit cssClass="btn btn-beoro-3" replaceTarget="true" value="Iniciar sesión" validate="true" validateFunction="bootstrapValidation"/>
                ...
                <div class="panel" style="display:none" id="divRestoreUser">
                    ...
                    <s:form id="formValidate" action="login.action" method="post" theme="simple">
                        ...
                        <div class="row">
                            ...
                            <div class="span6 control-group">
                                <label class="control-label" for="formValidate_celphone">Ingrese su correo/celular</label>
                                <div class="controls">
                                    <s:textfield id="formValidate_celphone" name="celphone" />
                                </div>
                            </div>
                            <!--                            <div class="span6">
                            ...
                            <div class="submit_sect">
                                ...
                                <sj:submit cssClass="btn btn-beoro-3" replaceTarget="true" value="Recuperar" validate="true" validateFunction="bootstrapValidation"/>
                            </div>
                        </div>
                    </s:form>
                </div>
                    ...
                    <s:form id="formNewUser" action="saveUser.action" method="post" theme="simple">
                        ...
                        <div class="row">
                            ...
                            <div class="span4">
                                ...
                                <sj:submit cssClass="btn btn-beoro-3" onCompleteTopics="completeUser" value="Crear usuario" validate="true" validateFunction="validationForm"/>
                            </div>
                        </div>                            
                    </s:form>
                    <script>
