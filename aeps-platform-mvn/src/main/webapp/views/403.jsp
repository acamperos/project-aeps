            ...
            <div class="row">
                <div class="span12">
                    <div class="hero-unit center">
                        <h1>Permiso no autorizado <small><font face="Tahoma" color="red">Error 403</font></small></h1>
                        <br />
                        <p>Usted no cuenta con los permisos necesarios para realizar esta accion, comuniquese con el administrador respectivo o intente mas tarde.</p> 
<!--                            Use your browsers <b>Back</b> button to navigate to the page you have prevously come from</p>
                        <p><b>Or you could just press this neat little button:</b></p>-->
                        <a href="home.action" class="btn btn-large btn-info"><i class="icon-home icon-white"></i> Llevar al inicio</a>
                    </div>
                </div>
            </div>
        </div>
